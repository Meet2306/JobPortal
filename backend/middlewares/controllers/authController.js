...
const registerSchema = Joi.object({
    ...
    phoneNumber: Joi.string().regex(/^[789]\d{9}$/).allow('').optional()
        .messages({ 'string.pattern.base': 'Company Phone number must be exactly 10 digits and start with 7, 8, or 9' }),
